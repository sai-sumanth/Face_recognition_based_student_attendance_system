...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img5=Image.open(r"D:\Face Detection Based Attendence System\images\detector.png")
        ...
        b2_1=Button(bg_img,command=self.face_data,text="Face Detector",cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="red")
        ...
        #train button
        img7=Image.open(r"D:\Face Detection Based Attendence System\images\train.png")
        img7=img7.resize((220,220),Image.ANTIALIAS)
        self.photoimg7=ImageTk.PhotoImage(img7)

        b2=Button(bg_img,image=self.photoimg7,command=self.train_data,cursor="hand2")
        b2.place(x=1100,y=100,width=220,height=220)

        b2_1=Button(bg_img,text="Train Data",command=self.train_data,cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="red")
        b2_1.place(x=1100,y=300,width=220,height=40)


        #photos
        img8=Image.open(r"D:\Face Detection Based Attendence System\images\photos.png")
        img8=img8.resize((220,220),Image.ANTIALIAS)
        self.photoimg8=ImageTk.PhotoImage(img8)

        b2=Button(bg_img,command=self.open_img,image=self.photoimg8,cursor="hand2")
        b2.place(x=200,y=380,width=220,height=220)

        b2_1=Button(bg_img,text="Photos",command=self.open_img,cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="red")
